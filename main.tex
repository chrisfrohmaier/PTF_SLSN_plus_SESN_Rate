...
The literature sample, including our own CCSN and SESN rate measurements, are presented in Figure~\ref{fig:rates_CC_lit} and illustrates that the CCSN rate increases with redshift. This reflects the increasing SFR with look back time as CCSNe explode promptly after explosion on cosmic time scales. We normalised a functional for the cosmic Star Formation History as parameterised by \citet{2008MNRAS.388.1487L} with the Cole 2001 functional form. This is presented in Figure blah by the blue dahsed lines, with the 1 sigma uncertainties represetned by the hatched markings.

Scale by Shivver, get SESN
