...
\citep{2009A&A...499..653B} rolling search with candidates out to redshifts $z,0.4$. They find the CCSN rate to be $1.42 \pm 0.3\mathrm{(stat) \pm 0.3 \mathrm{(sys)} \times10^{-4}\,\text{SNe yr}^{-1}\,\text{Mpc}^{-3}\, h_{70}^{3} $ at $z=0.3$.
