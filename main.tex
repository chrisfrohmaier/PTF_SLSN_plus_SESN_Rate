...
%Comment out the line below to enable hyperlinks which were crashing the overleaf compile
\hypersetup{draft}
...
SLSNe-I are intrinsically rare events, with an estimated rate of 0.001\% of the core-collapse SN (CCSN) rate in the local Universe \citep{Quimby2011,Quimby2013,McCrum2015}, which ostensibly increases with redshift, following trends in the cosmic star formation history \citep{Prajs2016,Cooke2012,2019ApJS..241...16M}. 
